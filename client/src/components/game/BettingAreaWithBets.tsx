      ...
      <style>
        {`
          ...
          @keyframes progressiveYellowBorder {
            0% {
              box-shadow: inset 0 0 15px 2px rgba(250, 204, 21, 0.4);
              border-color: rgba(250, 204, 21, 0.6);
            }
            50% {
              box-shadow: inset 0 0 40px 10px rgba(250, 204, 21, 0.9);
          ...
          .border-winning {
            animation: progressiveYellowBorder 1.2s ease-in-out infinite !important;
